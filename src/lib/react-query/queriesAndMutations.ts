...
export const useCreatePost = () => {
    ...
    return useMutation({
        ...
        onSuccess: () => {
            ...
            console.log(QUERY_KEYS.GET_RECENT_POSTS, "from useCreatePost")
        }
    })
};
...
export const useLikePost = () => {
    ...
    return useMutation({
        ...
        onSuccess: (data) => {
            // here will get the id in likesArray whoever likes the post and then we check length of the array
            queryClient.invalidateQueries({
